...
public type DomesticStandingOrderResponse record {|
    # Data object Domestic Standing Order Response
    DomesticStandingOrderResponseData Data;
...
public type DomesticStandingOrderResponseData record {|
    ...
    # movement of funds from the debtor account to a creditor for a domestic standing order.
